    ...
    <main>
        ...
        <div className="relative max-w-3xl mx-auto px-6 py-16 md:py-24">
          ...
          <div className="flex flex-wrap items-center gap-4 text-sm text-gray-300">
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-full bg-gold flex items-center justify-center text-xs font-bold text-primary">
                G
              </div>
      ...
      <section className="bg-white py-12">
        <div className="max-w-3xl mx-auto px-6">
          ...
          {/* Mid-article CTA */}
          <div className="my-12 bg-white-soft border border-gold rounded-lg p-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link
                href="/recursos"
                className="border border-primary text-primary hover:bg-primary hover:text-white font-medium text-sm px-5 py-2 rounded transition-colors"
              >
      ...
      {/* Author Bio */}
      <section className="bg-white-soft py-12">
        <div className="max-w-3xl mx-auto px-6">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 bg-white rounded-lg p-6 shadow-sm">
            <div className="w-20 h-20 rounded-full bg-white-soft overflow-hidden shrink-0 relative border-2 border-gold">
              <Image
            ...
            <div>
              ...
              <h3 className="text-base font-bold text-primary mb-1">{post.author}</h3>
      ...
      {relatedPosts.length > 0 && (
        <section className="bg-white py-16">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-2xl font-bold text-primary mb-8">Sigue explorando</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {relatedPosts.map((related) => {
                ...
                return (
                  ...
                  >
                    <div className="relative w-full h-40 bg-white-soft">
                      <Image
                        src={related.image}
                    ...
                    <div className="p-4 flex flex-col flex-1">
                      ...
                      <h3 className="text-sm font-bold text-primary leading-snug flex-1">{related.title}</h3>
                      <div className="flex items-center justify-between mt-3">
                        <span className="text-xs text-gray-400">{related.readTime} min</span>
                        <Link
                          href={`/blog/${related.slug}`}
                          className="text-xs font-medium text-primary hover:text-gold transition-colors"
                        >
                          Leer →
                        </Link>
                      </div>
