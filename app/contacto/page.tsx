    ...
    <main>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            ...
            <div className="bg-white border border-gray-100 rounded-lg p-8 shadow-sm">
              <h2 className="text-xl font-bold text-primary mb-6">Envíame un mensaje</h2>
              <ContactForm />
            </div>

            {/* Consultation Card */}
            <div className="bg-primary text-white rounded-lg p-8 flex flex-col gap-6">
              <div
                className="w-14 h-14 rounded-full bg-gold/20 border-2 border-gold flex items-center justify-center"
                aria-hidden="true"
              >
              ...
              <a
                ...
                className="inline-block bg-gold hover:bg-gold-hover text-primary font-semibold text-sm px-6 py-3 rounded transition-colors text-center"
              >
                Reservar mi espacio →
              </a>
            </div>
      ...
      <section className="bg-white-soft py-16">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="text-2xl font-bold text-primary mb-10">O escríbeme directamente</h2>
      ...
      <section className="bg-white py-16">
        <div className="max-w-2xl mx-auto px-6">
          <div className="bg-primary rounded-lg p-8 text-center">
            <div
              className="w-12 h-12 rounded-full bg-gold/20 border-2 border-gold flex items-center justify-center mx-auto mb-4"
              aria-hidden="true"
            >
